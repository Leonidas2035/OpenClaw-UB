...
<!-- For checkpoint task examples and patterns, see @~/.openclaw/get-shit-done/references/checkpoints.md -->
...
See `~/.openclaw/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `~/.openclaw/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `~/.openclaw/get-shit-done/workflows/verify-phase.md` for verification logic.
