...
3. **Independent commits:** Each sub-repo receives its own atomic commit via `gsd-sdk query commit-to-subrepo`. File paths are made relative to the sub-repo root before staging.
