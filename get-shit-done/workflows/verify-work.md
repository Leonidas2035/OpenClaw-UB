...
<template>
@~/.openclaw/get-shit-done/templates/UAT.md
</template>
...
Read and follow `~/.openclaw/get-shit-done/workflows/transition.md`.
...
- Follow @~/.openclaw/get-shit-done/workflows/diagnose-issues.md
