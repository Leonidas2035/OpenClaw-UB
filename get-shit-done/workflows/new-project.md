...
SPIKE_SKILL=$(ls ./.openclaw/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.openclaw/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1)
...
Use template: ~/.openclaw/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: ~/.openclaw/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: ~/.openclaw/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ~/.openclaw/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: ~/.openclaw/get-shit-done/templates/research-project/SUMMARY.md
