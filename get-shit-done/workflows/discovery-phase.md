...
See ~/.openclaw/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.openclaw/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.openclaw/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.openclaw/get-shit-done/templates/discovery.md
...
Use ~/.openclaw/get-shit-done/templates/discovery.md.
