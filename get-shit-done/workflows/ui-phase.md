...
```markdown
Read ~/.openclaw/get-shit-done/agents/gsd-ui-researcher.md for instructions.
...
Template: ~/.openclaw/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read ~/.openclaw/get-shit-done/agents/gsd-ui-checker.md for instructions.
