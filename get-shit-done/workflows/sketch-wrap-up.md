...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.openclaw/skills/sketch-findings-[project]/`
...
3. Check if `./.openclaw/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.openclaw/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.openclaw/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.openclaw/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.openclaw/skills/` with SKILL.md, references/, sources/
