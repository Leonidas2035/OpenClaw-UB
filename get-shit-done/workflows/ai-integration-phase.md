...
<required_reading>
@~/.openclaw/get-shit-done/references/ai-frameworks.md
@~/.openclaw/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read ~/.openclaw/get-shit-done/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "$HOME/.openclaw/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read ~/.openclaw/get-shit-done/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read ~/.openclaw/get-shit-done/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read ~/.openclaw/get-shit-done/agents/gsd-eval-planner.md for instructions.
