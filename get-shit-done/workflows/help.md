...
- Generates `./.openclaw/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.openclaw/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `~/.openclaw/notes/` globally)
