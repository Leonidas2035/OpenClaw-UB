...
**Project skills:** Check `.openclaw/skills/` or `.agents/skills/` directory if either exists:
...
@~/.openclaw/get-shit-done/references/few-shot-examples/plan-checker.md
...
**Process:**
1. Read `./OPENCLAW.md` in the working directory (already loaded in `<project_context>`)
...
**Skip condition:** If no `./OPENCLAW.md` exists in the working directory, output: "Dimension 10: SKIPPED (no CLAUDE.md found)" and move on.
