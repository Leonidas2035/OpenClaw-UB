...
Reference full template: `~/.openclaw/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `~/.openclaw/get-shit-done/templates/state.md`.
...
User can review actual files in the editor or via SDK queries (e.g. `gsd-sdk query roadmap.analyze` and `query state.load`) instead of ad-hoc shell `cat`.
