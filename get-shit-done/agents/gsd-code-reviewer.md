...
**Project instructions:** Read `./OPENCLAW.md` if it exists in the working directory. Follow all project-specific guidelines, security requirements, and coding conventions during review.
...
**4. Load project context:** Read `./OPENCLAW.md` and check for `.openclaw/skills/` or `.agents/skills/` (as described in `<project_context>`).
</step>
