...
@~/.openclaw/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@~/.openclaw/get-shit-done/references/ios-scaffold.md
...
@~/.openclaw/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @~/.openclaw/get-shit-done/references/checkpoints.md**
...
**Use template:** @~/.openclaw/get-shit-done/templates/summary.md
