...
<required_reading>
@~/.openclaw/get-shit-done/references/verification-overrides.md
...
@~/.openclaw/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@~/.openclaw/get-shit-done/references/few-shot-examples/verifier.md
