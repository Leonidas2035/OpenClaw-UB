...
<required_reading>
@~/.openclaw/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@~/.openclaw/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks ~/.openclaw/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ~/.openclaw/get-shit-done
                  → writes to ~/.openclaw/get-shit-done/hooks/
...
@~/.openclaw/get-shit-done/references/thinking-models-debug.md
...
- Read @~/.openclaw/get-shit-done/references/common-bug-patterns.md
