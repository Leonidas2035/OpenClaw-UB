...
<reference>
@~/.openclaw/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `~/.openclaw/get-shit-done/references/user-profiling.md` to load:
